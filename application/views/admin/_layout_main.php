    ...
    <div class="containerk">
      <!-- Menu button for smallar screens -->
		<div class="navbar-header">
		  ...
		  <a href="<?php echo site_url('admin/dashboard')?>" class="navbar-brand"><img src="<?php echo base_url('admin-assets/img/custom/logo-system-mini.png');?>" /><span class="bold">Platforma Turistike</span></a>
		</div>
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown dropdown-big">
              <a class="dropdown-toggle" href="#" data-toggle="dropdown">
                <i class="icon-envelope-alt"></i> <?php echo lang_check('Messages');?> <span class="badge badge-important"><?php echo $this->enquire_m->total_unreaded();?></span> 
              </a>

                <ul class="dropdown-menu">
                  <li>
                    <!-- Heading - h5 -->
                    <h5><i class="icon-envelope-alt"></i> <?php echo lang_check('Messages');?></h5>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-inner">
          ...
          <ul class="navi">
            ...
            <?php if(config_item('admin_beginner_enabled') === TRUE):?>
                <?php if(check_acl('user')):?>
                <li class="norange<?php echo (strpos($this->uri->uri_string(),'user')!==FALSE && strpos($this->uri->uri_string(),'user/edit/'.$this->session->userdata('id'))===FALSE)?' current':'';?>"><a href="<?php echo site_url('admin/user')?>"><i class="icon-list-alt"></i> <?php echo lang_check('Administrators & Users');?></a></li>
                <?php endif;?>
                ...
                <?php if(check_acl('enquire') && config_db_item('frontend_disabled') === FALSE):?>
                    <li class="has_submenu nred<?php echo (strpos($this->uri->uri_string(),'enquire')!==FALSE)?' current open':'';?>">
                      <a href="#">
                        <!-- Menu name with icon -->
                        <i class="icon-envelope-alt"></i> <?php echo lang_check('Messages');?> 
                        <!-- Icon for dropdown -->
                        <span class="pull-right"><i class="icon-angle-right"></i></span>
                      </a>
